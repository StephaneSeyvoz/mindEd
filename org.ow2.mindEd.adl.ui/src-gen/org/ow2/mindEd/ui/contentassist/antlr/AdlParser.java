...
public class AdlParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.ow2.mindEd.ui.contentassist.antlr.internal.InternalAdlParser createParser() {
		org.ow2.mindEd.ui.contentassist.antlr.internal.InternalAdlParser result = new org.ow2.mindEd.ui.contentassist.antlr.internal.InternalAdlParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIDTTypeAccess().getAlternatives_2(), "rule__IDTType__Alternatives_2");
					...
					put(grammarAccess.getArgumentDefinitionAccess().getAlternatives_1(), "rule__ArgumentDefinition__Alternatives_1");
					...
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getGroup(), "rule__OutputFlowInterfaceDefinition__Group__0");
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getGroup_5(), "rule__OutputFlowInterfaceDefinition__Group_5__0");
					put(grammarAccess.getInputFlowInterfaceDefinitionAccess().getGroup(), "rule__InputFlowInterfaceDefinition__Group__0");
					put(grammarAccess.getInputFlowInterfaceDefinitionAccess().getGroup_6(), "rule__InputFlowInterfaceDefinition__Group_6__0");
					put(grammarAccess.getIDTTypeAccess().getGroup(), "rule__IDTType__Group__0");
					...
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getAnnotationsListAssignment_0(), "rule__OutputFlowInterfaceDefinition__AnnotationsListAssignment_0");
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getRoleAssignment_1(), "rule__OutputFlowInterfaceDefinition__RoleAssignment_1");
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getSignatureAssignment_2(), "rule__OutputFlowInterfaceDefinition__SignatureAssignment_2");
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getNameAssignment_4(), "rule__OutputFlowInterfaceDefinition__NameAssignment_4");
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getCollectionAssignment_5_0(), "rule__OutputFlowInterfaceDefinition__CollectionAssignment_5_0");
					put(grammarAccess.getOutputFlowInterfaceDefinitionAccess().getCollectionsizeAssignment_5_1(), "rule__OutputFlowInterfaceDefinition__CollectionsizeAssignment_5_1");
					put(grammarAccess.getInputFlowInterfaceDefinitionAccess().getAnnotationsListAssignment_0(), "rule__InputFlowInterfaceDefinition__AnnotationsListAssignment_0");
					put(grammarAccess.getInputFlowInterfaceDefinitionAccess().getRoleAssignment_1(), "rule__InputFlowInterfaceDefinition__RoleAssignment_1");
					put(grammarAccess.getInputFlowInterfaceDefinitionAccess().getOptionalAssignment_2(), "rule__InputFlowInterfaceDefinition__OptionalAssignment_2");
					put(grammarAccess.getInputFlowInterfaceDefinitionAccess().getSignatureAssignment_3(), "rule__InputFlowInterfaceDefinition__SignatureAssignment_3");
					...
					put(grammarAccess.getArgumentDefinitionAccess().getArgumentValueAssignment_1_0(), "rule__ArgumentDefinition__ArgumentValueAssignment_1_0");
					put(grammarAccess.getArgumentDefinitionAccess().getArgumentListAssignment_1_1(), "rule__ArgumentDefinition__ArgumentListAssignment_1_1");
					...
					put(grammarAccess.getAttributeDefinitionAccess().getNameAssignment_3(), "rule__AttributeDefinition__NameAssignment_3");
					...
					put(grammarAccess.getImplementationDefinitionAccess().getCFileAssignment_2_0(), "rule__ImplementationDefinition__CFileAssignment_2_0");
