...
public class AdlFileRenameParticipant extends
AbstractProcessorBasedRenameParticipant {
	 ...
	 * {@link AdlFileRenameParticipant#createRenameElementContexts} method.
	 */
	@Override
	...
	protected List<? extends IRenameElementContext> createRenameElementContexts(Object element) {
		...
		if (xtextContents.size() == 1 && xtextContents.get(0) instanceof AdlFile) {
			...
			IRenameElementContext context = new AdlFileRenameElementContext(renamedArchDefURI, renamedArchDef.eClass());
