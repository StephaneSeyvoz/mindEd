 ...
 *   <li>{@link org.ow2.mindEd.adl.SubComponentDefinition#getArgumentsList <em>Arguments List</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.SubComponentDefinition#getName <em>Name</em>}</li>
...
public interface SubComponentDefinition extends CompositeElement
{
   ...
   * @see org.ow2.mindEd.adl.AdlPackage#getSubComponentDefinition_Type()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.SubComponentDefinition#getType <em>Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.adl.AdlPackage#getSubComponentDefinition_TemplatesList()
   ...
   * @see org.ow2.mindEd.adl.AdlPackage#getSubComponentDefinition_ArgumentsList()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setName(String)
   * @see org.ow2.mindEd.adl.AdlPackage#getSubComponentDefinition_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.SubComponentDefinition#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.adl.AdlPackage#getSubComponentDefinition_BodyAnnotationsList()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.SubComponentDefinition#getBodyAnnotationsList <em>Body Annotations List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.adl.AdlPackage#getSubComponentDefinition_Body()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.SubComponentDefinition#getBody <em>Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
