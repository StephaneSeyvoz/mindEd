...
public class AnnotationElementImpl extends MinimalEObjectImpl.Container implements AnnotationElement
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.ANNOTATION_ELEMENT__NAME, oldName, name));
  }
  ...
  public void setElementValue(ElementValue newElementValue)
  {
    if (newElementValue != elementValue)
    {
      ...
      if (newElementValue != null)
        msgs = ((InternalEObject)newElementValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdlPackage.ANNOTATION_ELEMENT__ELEMENT_VALUE, null, msgs);
