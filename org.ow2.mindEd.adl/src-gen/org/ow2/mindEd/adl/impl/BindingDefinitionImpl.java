 ...
 *   <li>{@link org.ow2.mindEd.adl.impl.BindingDefinitionImpl#getSourceInterface <em>Source Interface</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.impl.BindingDefinitionImpl#getSourceIndex <em>Source Index</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.impl.BindingDefinitionImpl#getTargetParent <em>Target Parent</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.impl.BindingDefinitionImpl#isIsTgtParentThis <em>Is Tgt Parent This</em>}</li>
...
public class BindingDefinitionImpl extends CompositeElementImpl implements BindingDefinition
{
    ...
    if (sourceParent != null && sourceParent.eIsProxy())
    {
      ...
      if (sourceParent != oldSourceParent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdlPackage.BINDING_DEFINITION__SOURCE_PARENT, oldSourceParent, sourceParent));
      }
    }
    return sourceParent;
  }
  ...
  public void setSourceParent(SubComponentDefinition newSourceParent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__SOURCE_PARENT, oldSourceParent, sourceParent));
  }
  ...
  public void setIsSrcParentThis(boolean newIsSrcParentThis)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__IS_SRC_PARENT_THIS, oldIsSrcParentThis, isSrcParentThis));
  }
  ...
  public HostedInterfaceDefinition getSourceInterface()
  {
    if (sourceInterface != null && sourceInterface.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdlPackage.BINDING_DEFINITION__SOURCE_INTERFACE, oldSourceInterface, sourceInterface));
      }
    }
  ...
  public void setSourceInterface(HostedInterfaceDefinition newSourceInterface)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__SOURCE_INTERFACE, oldSourceInterface, sourceInterface));
  }
  ...
  public void setSourceIndex(int newSourceIndex)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__SOURCE_INDEX, oldSourceIndex, sourceIndex));
  }
  ...
  public SubComponentDefinition getTargetParent()
  {
    if (targetParent != null && targetParent.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdlPackage.BINDING_DEFINITION__TARGET_PARENT, oldTargetParent, targetParent));
      }
    }
    return targetParent;
  }
  ...
  public void setTargetParent(SubComponentDefinition newTargetParent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__TARGET_PARENT, oldTargetParent, targetParent));
  }
  ...
  public void setIsTgtParentThis(boolean newIsTgtParentThis)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__IS_TGT_PARENT_THIS, oldIsTgtParentThis, isTgtParentThis));
  }
  ...
  public HostedInterfaceDefinition getTargetInterface()
  {
    if (targetInterface != null && targetInterface.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdlPackage.BINDING_DEFINITION__TARGET_INTERFACE, oldTargetInterface, targetInterface));
      }
    }
  ...
  public void setTargetInterface(HostedInterfaceDefinition newTargetInterface)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__TARGET_INTERFACE, oldTargetInterface, targetInterface));
  }
  ...
  public void setTargetIndex(int newTargetIndex)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.BINDING_DEFINITION__TARGET_INDEX, oldTargetIndex, targetIndex));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AdlPackage.BINDING_DEFINITION__SOURCE_PARENT:
      ...
      case AdlPackage.BINDING_DEFINITION__SOURCE_INTERFACE:
      ...
      case AdlPackage.BINDING_DEFINITION__TARGET_PARENT:
      ...
      case AdlPackage.BINDING_DEFINITION__TARGET_INTERFACE:
