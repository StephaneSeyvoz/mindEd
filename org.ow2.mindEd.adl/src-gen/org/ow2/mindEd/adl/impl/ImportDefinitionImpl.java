...
public class ImportDefinitionImpl extends MinimalEObjectImpl.Container implements ImportDefinition
{
  ...
  public NotificationChain basicSetAnnotationsList(AnnotationsList newAnnotationsList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdlPackage.IMPORT_DEFINITION__ANNOTATIONS_LIST, oldAnnotationsList, newAnnotationsList);
  ...
  public void setAnnotationsList(AnnotationsList newAnnotationsList)
  {
    if (newAnnotationsList != annotationsList)
    {
      ...
      if (annotationsList != null)
        msgs = ((InternalEObject)annotationsList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdlPackage.IMPORT_DEFINITION__ANNOTATIONS_LIST, null, msgs);
      if (newAnnotationsList != null)
        msgs = ((InternalEObject)newAnnotationsList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdlPackage.IMPORT_DEFINITION__ANNOTATIONS_LIST, null, msgs);
      msgs = basicSetAnnotationsList(newAnnotationsList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.IMPORT_DEFINITION__ANNOTATIONS_LIST, newAnnotationsList, newAnnotationsList));
  }
  ...
  public void setImportedNamespace(String newImportedNamespace)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.IMPORT_DEFINITION__IMPORTED_NAMESPACE, oldImportedNamespace, importedNamespace));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AdlPackage.IMPORT_DEFINITION__ANNOTATIONS_LIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AdlPackage.IMPORT_DEFINITION__IMPORTED_NAMESPACE:
