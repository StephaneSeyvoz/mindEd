...
public class PrimitiveDefinitionImpl extends ArchitectureDefinitionImpl implements PrimitiveDefinition
{
  ...
  public NotificationChain basicSetCompositeFormalArgumentsList(FormalArgumentsList newCompositeFormalArgumentsList, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdlPackage.PRIMITIVE_DEFINITION__COMPOSITE_FORMAL_ARGUMENTS_LIST, oldCompositeFormalArgumentsList, newCompositeFormalArgumentsList);
  ...
  public void setCompositeFormalArgumentsList(FormalArgumentsList newCompositeFormalArgumentsList)
  {
    if (newCompositeFormalArgumentsList != compositeFormalArgumentsList)
    {
      ...
      if (compositeFormalArgumentsList != null)
        msgs = ((InternalEObject)compositeFormalArgumentsList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdlPackage.PRIMITIVE_DEFINITION__COMPOSITE_FORMAL_ARGUMENTS_LIST, null, msgs);
      if (newCompositeFormalArgumentsList != null)
        msgs = ((InternalEObject)newCompositeFormalArgumentsList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdlPackage.PRIMITIVE_DEFINITION__COMPOSITE_FORMAL_ARGUMENTS_LIST, null, msgs);
      msgs = basicSetCompositeFormalArgumentsList(newCompositeFormalArgumentsList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.PRIMITIVE_DEFINITION__COMPOSITE_FORMAL_ARGUMENTS_LIST, newCompositeFormalArgumentsList, newCompositeFormalArgumentsList));
  }
  ...
  public EList<PrimitiveSuperType> getSuperTypes()
  {
    if (superTypes == null)
    {
      superTypes = new EObjectContainmentEList<PrimitiveSuperType>(PrimitiveSuperType.class, this, AdlPackage.PRIMITIVE_DEFINITION__SUPER_TYPES);
    }
    return superTypes;
  }
  ...
  public EList<PrimitiveElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<PrimitiveElement>(PrimitiveElement.class, this, AdlPackage.PRIMITIVE_DEFINITION__ELEMENTS);
    }
    return elements;
  }
