...
public class PrimitiveSuperTypeImpl extends MinimalEObjectImpl.Container implements PrimitiveSuperType
{
  ...
  {
    return AdlPackage.Literals.PRIMITIVE_SUPER_TYPE;
  }
    ...
    if (targetArchDef != null && targetArchDef.eIsProxy())
    {
      ...
      if (targetArchDef != oldTargetArchDef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdlPackage.PRIMITIVE_SUPER_TYPE__TARGET_ARCH_DEF, oldTargetArchDef, targetArchDef));
      }
    }
  ...
  public void setTargetArchDef(PrimitiveSuperTypeDefinition newTargetArchDef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.PRIMITIVE_SUPER_TYPE__TARGET_ARCH_DEF, oldTargetArchDef, targetArchDef));
  }
  ...
  public EList<ArgumentDefinition> getArgumentsList()
  {
    ...
    {
      argumentsList = new EObjectContainmentEList<ArgumentDefinition>(ArgumentDefinition.class, this, AdlPackage.PRIMITIVE_SUPER_TYPE__ARGUMENTS_LIST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AdlPackage.PRIMITIVE_SUPER_TYPE__ARGUMENTS_LIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AdlPackage.PRIMITIVE_SUPER_TYPE__TARGET_ARCH_DEF:
