...
public class TemplateSpecifierImpl extends TypeReferenceImpl implements TemplateSpecifier
{
    ...
    if (typeReference != null && typeReference.eIsProxy())
    {
      ...
      if (typeReference != oldTypeReference)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdlPackage.TEMPLATE_SPECIFIER__TYPE_REFERENCE, oldTypeReference, typeReference));
      }
    }
  ...
  public void setTypeReference(TypeDefinition newTypeReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdlPackage.TEMPLATE_SPECIFIER__TYPE_REFERENCE, oldTypeReference, typeReference));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AdlPackage.TEMPLATE_SPECIFIER__TYPE_REFERENCE:
