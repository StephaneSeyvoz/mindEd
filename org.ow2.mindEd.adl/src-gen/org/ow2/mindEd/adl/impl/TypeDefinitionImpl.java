...
public class TypeDefinitionImpl extends ArchitectureDefinitionImpl implements TypeDefinition
{
  ...
  {
    return AdlPackage.Literals.TYPE_DEFINITION;
  }
  ...
  public EList<TypeDefinition> getSuperTypes()
  {
    if (superTypes == null)
    {
      superTypes = new EObjectResolvingEList<TypeDefinition>(TypeDefinition.class, this, AdlPackage.TYPE_DEFINITION__SUPER_TYPES);
    }
    return superTypes;
  }
  ...
  public EList<HostedInterfaceDefinition> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<HostedInterfaceDefinition>(HostedInterfaceDefinition.class, this, AdlPackage.TYPE_DEFINITION__ELEMENTS);
    }
    return elements;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AdlPackage.TYPE_DEFINITION__SUPER_TYPES:
