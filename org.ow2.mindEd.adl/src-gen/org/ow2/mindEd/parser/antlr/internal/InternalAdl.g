...
(
    ...
    { 
        $current = $this_OutputFlowInterfaceDefinition_2.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_InputFlowInterfaceDefinition_3.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleOutputFlowInterfaceDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getOutputFlowInterfaceDefinitionRule()); }
	 ...
	 { $current=$iv_ruleOutputFlowInterfaceDefinition.current; } 
	 EOF 
;

// Rule OutputFlowInterfaceDefinition
ruleOutputFlowInterfaceDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleInputFlowInterfaceDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getInputFlowInterfaceDefinitionRule()); }
	 ...
	 { $current=$iv_ruleInputFlowInterfaceDefinition.current; } 
	 EOF 
;

// Rule InputFlowInterfaceDefinition
ruleInputFlowInterfaceDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    { 
        $current = $this_IDTType_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleIDTType returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getIDTTypeRule()); }
	 iv_ruleIDTType=ruleIDTType 
	 { $current=$iv_ruleIDTType.current; } 
	 EOF 
;

// Rule IDTType
ruleIDTType returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
