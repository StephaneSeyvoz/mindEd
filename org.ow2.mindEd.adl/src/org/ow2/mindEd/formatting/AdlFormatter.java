...
public class AdlFormatter extends AbstractDeclarativeFormatter {
	...
	protected void configureFormatting(FormattingConfig c) {
		AdlGrammarAccess f = (AdlGrammarAccess) getGrammarAccess();
	 ...
	 */
	private void formatCompositeDefinition(FormattingConfig c, AdlGrammarAccess f) {
		c.setLinewrap(0, 1, 2).after(f.getCompositeDefinitionAccess().getLeftCurlyBracketKeyword_6());
		c.setLinewrap(0, 1, 2).before(f.getCompositeDefinitionAccess().getRightCurlyBracketKeyword_8());

		// Set indentation for inner elements
		c.setIndentation(f.getCompositeDefinitionAccess().getLeftCurlyBracketKeyword_6(), f.getCompositeDefinitionAccess().getRightCurlyBracketKeyword_8());
	}
	 ...
	 * INSERT LINE WRAP BEFORE }
	 */
	private void formatPrimitiveDefinition(FormattingConfig c, AdlGrammarAccess f) {
		c.setLinewrap(0, 1, 2).after(f.getPrimitiveDefinitionAccess().getLeftCurlyBracketKeyword_6());
		c.setLinewrap(0, 1, 2).before(f.getPrimitiveDefinitionAccess().getRightCurlyBracketKeyword_8());

		// Set indentation for inner elements
		c.setIndentation(f.getPrimitiveDefinitionAccess().getLeftCurlyBracketKeyword_6(), f.getPrimitiveDefinitionAccess().getRightCurlyBracketKeyword_8());
	}
	 ...
	 * INSERT LINE WRAP BEFORE }
	 */
	private void formatTypeDefinition(FormattingConfig c, AdlGrammarAccess f) {
	 ...
	 * @param f
	 */
	private void formatDataDefinition(FormattingConfig c, AdlGrammarAccess f) {
