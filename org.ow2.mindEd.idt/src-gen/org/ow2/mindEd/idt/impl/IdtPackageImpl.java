 ...
 * @generated
 */
public class IdtPackageImpl extends EPackageImpl implements IdtPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.idt.IdtPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private IdtPackageImpl()
  {
    super(eNS_URI, IdtFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link IdtPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static IdtPackage init()
  {
    if (isInited) return (IdtPackage)EPackage.Registry.INSTANCE.getEPackage(IdtPackage.eNS_URI);

    // Obtain or create and register package
    IdtPackageImpl theIdtPackage = (IdtPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof IdtPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new IdtPackageImpl());

    isInited = true;

    // Initialize simple dependencies
    ItfPackage.eINSTANCE.eClass();

    // Create package meta-data objects
    theIdtPackage.createPackageContents();

    // Initialize created meta-data
    theIdtPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theIdtPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(IdtPackage.eNS_URI, theIdtPackage);
    return theIdtPackage;
  }
   ...
   * @generated
   */
  public IdtFactory getIdtFactory()
  {
    return (IdtFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    ItfPackage theItfPackage = (ItfPackage)EPackage.Registry.INSTANCE.getEPackage(ItfPackage.eNS_URI);
    ...
    initEReference(getIdtFile_Def(), theItfPackage.getConstantDefinition(), null, "def", null, 0, 1, IdtFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getIdtFile_Includes(), theItfPackage.getIncludeDirective(), null, "includes", null, 0, -1, IdtFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getIdtFile_Constant(), theItfPackage.getConstantDefinition(), null, "constant", null, 0, -1, IdtFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getIdtFile_Type(), theItfPackage.getTypeDefinition(), null, "type", null, 0, -1, IdtFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
