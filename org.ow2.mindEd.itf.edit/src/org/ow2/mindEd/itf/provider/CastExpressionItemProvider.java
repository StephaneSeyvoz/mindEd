...
/**
 * This is the item provider adapter for a {@link org.ow2.mindEd.itf.CastExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CastExpressionItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ItfPackage.Literals.CAST_EXPRESSION__TYPE);
			childrenFeatures.add(ItfPackage.Literals.CAST_EXPRESSION__EXPR);
			childrenFeatures.add(ItfPackage.Literals.CAST_EXPRESSION__UNARY_EXPR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.CAST_EXPRESSION__TYPE,
				 ItfFactory.eINSTANCE.createQualifiedTypeSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.CAST_EXPRESSION__EXPR,
				 ItfFactory.eINSTANCE.createCastExpression()));

		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.CAST_EXPRESSION__UNARY_EXPR,
