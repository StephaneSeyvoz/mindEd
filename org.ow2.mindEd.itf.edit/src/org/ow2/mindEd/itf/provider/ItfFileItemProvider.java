...
/**
 * This is the item provider adapter for a {@link org.ow2.mindEd.itf.ItfFile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItfFileItemProvider 
	 ...
	 * @generated
	 */
	public ItfFileItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ItfPackage.Literals.ITF_FILE__INCLUDES);
			childrenFeatures.add(ItfPackage.Literals.ITF_FILE__CONSTANT);
			childrenFeatures.add(ItfPackage.Literals.ITF_FILE__TYPE);
			childrenFeatures.add(ItfPackage.Literals.ITF_FILE__INTERFACE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ItfFile"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_ItfFile_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ItfFile.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.ITF_FILE__INCLUDES,
				 ItfFactory.eINSTANCE.createIncludeDirective()));

		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.ITF_FILE__CONSTANT,
				 ItfFactory.eINSTANCE.createConstantDefinition()));

		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.ITF_FILE__TYPE,
		...
		newChildDescriptors.add
			(createChildParameter
				(ItfPackage.Literals.ITF_FILE__INTERFACE,
