...
/**
 * This is the item provider adapter for a {@link org.ow2.mindEd.itf.PrimaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimaryExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimaryExpression_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimaryExpression_literal_feature", "_UI_PrimaryExpression_type"),
				 ItfPackage.Literals.PRIMARY_EXPRESSION__LITERAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((PrimaryExpression)object).getLiteral();
		return label == null || label.length() == 0 ?
			getString("_UI_PrimaryExpression_type") :
			getString("_UI_PrimaryExpression_type") + " " + label;
	}
