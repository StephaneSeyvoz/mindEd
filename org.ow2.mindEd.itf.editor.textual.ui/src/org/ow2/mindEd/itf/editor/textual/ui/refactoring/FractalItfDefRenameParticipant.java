...
public class FractalItfDefRenameParticipant extends
AbstractProcessorBasedRenameParticipant {

	private InterfaceDefinition renamedItfDef = null;
	...
	protected boolean initialize(Object originalTargetElement) {
		...
		if (originalTargetElement instanceof IRenameElementContext) {
			...
			if (targetElementEObject instanceof InterfaceDefinition) {
				renamedItfDef = (InterfaceDefinition) targetElementEObject;
	...
	public Change createChange(IProgressMonitor pm) throws CoreException, OperationCanceledException {
		...
		IFile file = ResourceUtil.getFile(renamedItfDef.eResource());
