 ...
 * InterfaceDefinition in the model.
 * 
 ...
 * InterfaceDefinition EObject and our forcedNewName.
 * 
...
public class FractalItfFileRenameParticipant extends
AbstractProcessorBasedRenameParticipant {
	 ...
	 * 
	 * We override this behaviour with the computed new InterfaceDefinition name, according to the
	 * user-provided file name. "forcedNewName" is computed in our
	 * {@link FractalItfFileRenameParticipant#createRenameElementContexts} method.
	 */
	@Override
	...
	protected List<? extends IRenameElementContext> createRenameElementContexts(Object element) {
		...
		if (xtextContents.size() == 1 && xtextContents.get(0) instanceof ItfFile) {
			...
			InterfaceDefinition renamedItfDef = hostItfDef.getInterface();
			...
			String oldFullyQualifiedName = renamedItfDef.getName();
			...
			URI renamedItfDefURI = EcoreUtil2.getPlatformResourceOrNormalizedURI(renamedItfDef);
			IRenameElementContext context = new FractalItfFileRenameElementContext(renamedItfDefURI, renamedItfDef.eClass());
