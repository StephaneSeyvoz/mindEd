...
public class FractalItfStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.ow2.org/mindEd/itf/")) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("fractalitf", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("fractalitf", serviceProvider);
