...
public class ItfFileRenameParticipant extends
AbstractProcessorBasedRenameParticipant {
	 ...
	 * {@link ItfFileRenameParticipant#createRenameElementContexts} method.
	 */
	@Override
	...
	protected List<? extends IRenameElementContext> createRenameElementContexts(Object element) {
		...
		if (xtextContents.size() == 1 && xtextContents.get(0) instanceof ItfFile) {
			...
			IRenameElementContext context = new ItfFileRenameElementContext(renamedItfDefURI, renamedItfDef.eClass());
