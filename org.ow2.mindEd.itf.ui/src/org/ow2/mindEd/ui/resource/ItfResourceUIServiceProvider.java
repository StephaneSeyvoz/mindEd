 ...
 * 
 */
package org.ow2.mindEd.ui.resource;
 ...
 */
public class ItfResourceUIServiceProvider extends
		DefaultResourceUIServiceProvider {

	@Inject
	public ItfResourceUIServiceProvider(IResourceServiceProvider delegate) {
		super(delegate);
	}
