 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.AnnotationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.AnnotationImpl#getAnnotationParametersList <em>Annotation Parameters List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationImpl extends MinimalEObjectImpl.Container implements Annotation
{
  ...
  {
    return ItfPackage.Literals.ANNOTATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.ANNOTATION__NAME, oldName, name));
  }
  ...
  public EList<AnnotationValuePair> getAnnotationParametersList()
  {
    ...
    {
      annotationParametersList = new EObjectContainmentEList<AnnotationValuePair>(AnnotationValuePair.class, this, ItfPackage.ANNOTATION__ANNOTATION_PARAMETERS_LIST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.ANNOTATION__ANNOTATION_PARAMETERS_LIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ItfPackage.ANNOTATION__NAME:
        return getName();
      case ItfPackage.ANNOTATION__ANNOTATION_PARAMETERS_LIST:
