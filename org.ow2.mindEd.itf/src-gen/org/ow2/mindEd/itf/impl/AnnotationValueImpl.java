 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.AnnotationValueImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.AnnotationValueImpl#getArrayValue <em>Array Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationValueImpl extends MinimalEObjectImpl.Container implements AnnotationValue
{
  ...
  {
    return ItfPackage.Literals.ANNOTATION_VALUE;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.ANNOTATION_VALUE__VALUE, oldValue, value));
  }
  ...
  public NotificationChain basicSetArrayValue(ArrayAnnotationValue newArrayValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.ANNOTATION_VALUE__ARRAY_VALUE, oldArrayValue, newArrayValue);
  ...
  public void setArrayValue(ArrayAnnotationValue newArrayValue)
  {
    if (newArrayValue != arrayValue)
    {
      ...
      if (arrayValue != null)
        msgs = ((InternalEObject)arrayValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.ANNOTATION_VALUE__ARRAY_VALUE, null, msgs);
      if (newArrayValue != null)
        msgs = ((InternalEObject)newArrayValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.ANNOTATION_VALUE__ARRAY_VALUE, null, msgs);
      msgs = basicSetArrayValue(newArrayValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.ANNOTATION_VALUE__ARRAY_VALUE, newArrayValue, newArrayValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.ANNOTATION_VALUE__ARRAY_VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ItfPackage.ANNOTATION_VALUE__VALUE:
        return getValue();
      case ItfPackage.ANNOTATION_VALUE__ARRAY_VALUE:
