 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.ArrayAnnotationValueImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayAnnotationValueImpl extends MinimalEObjectImpl.Container implements ArrayAnnotationValue
{
  ...
  {
    return ItfPackage.Literals.ARRAY_ANNOTATION_VALUE;
  }
  ...
  public EList<AnnotationValue> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<AnnotationValue>(AnnotationValue.class, this, ItfPackage.ARRAY_ANNOTATION_VALUE__VALUES);
    }
    return values;
  }
