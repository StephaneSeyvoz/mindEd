 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.ArraySpecificationImpl#isUnspecifiedSize <em>Unspecified Size</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.ArraySpecificationImpl#getFixedSize <em>Fixed Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArraySpecificationImpl extends MinimalEObjectImpl.Container implements ArraySpecification
{
  ...
  {
    return ItfPackage.Literals.ARRAY_SPECIFICATION;
  }
  ...
  public void setUnspecifiedSize(boolean newUnspecifiedSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.ARRAY_SPECIFICATION__UNSPECIFIED_SIZE, oldUnspecifiedSize, unspecifiedSize));
  }
  ...
  public NotificationChain basicSetFixedSize(ConstantExpression newFixedSize, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.ARRAY_SPECIFICATION__FIXED_SIZE, oldFixedSize, newFixedSize);
  ...
  public void setFixedSize(ConstantExpression newFixedSize)
  {
    if (newFixedSize != fixedSize)
    {
      ...
      if (fixedSize != null)
        msgs = ((InternalEObject)fixedSize).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.ARRAY_SPECIFICATION__FIXED_SIZE, null, msgs);
      if (newFixedSize != null)
        msgs = ((InternalEObject)newFixedSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.ARRAY_SPECIFICATION__FIXED_SIZE, null, msgs);
      msgs = basicSetFixedSize(newFixedSize, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.ARRAY_SPECIFICATION__FIXED_SIZE, newFixedSize, newFixedSize));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.ARRAY_SPECIFICATION__FIXED_SIZE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ItfPackage.ARRAY_SPECIFICATION__UNSPECIFIED_SIZE:
