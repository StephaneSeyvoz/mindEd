 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.DeclaratorImpl#getPointer <em>Pointer</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.DeclaratorImpl#getDc <em>Dc</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.DeclaratorImpl#getDec <em>Dec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeclaratorImpl extends MinimalEObjectImpl.Container implements Declarator
{
  ...
  {
    return ItfPackage.Literals.DECLARATOR;
  }
  ...
  public EList<QualifiedPointerSpecification> getPointer()
  {
    if (pointer == null)
    {
      pointer = new EObjectContainmentEList<QualifiedPointerSpecification>(QualifiedPointerSpecification.class, this, ItfPackage.DECLARATOR__POINTER);
    }
    return pointer;
  }
  ...
  public NotificationChain basicSetDc(EObject newDc, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.DECLARATOR__DC, oldDc, newDc);
  ...
  public void setDc(EObject newDc)
  {
    if (newDc != dc)
    {
      ...
      if (dc != null)
        msgs = ((InternalEObject)dc).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.DECLARATOR__DC, null, msgs);
      if (newDc != null)
        msgs = ((InternalEObject)newDc).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.DECLARATOR__DC, null, msgs);
      msgs = basicSetDc(newDc, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.DECLARATOR__DC, newDc, newDc));
  }
  ...
  public NotificationChain basicSetDec(Declarator newDec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.DECLARATOR__DEC, oldDec, newDec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDec(Declarator newDec)
  {
    if (newDec != dec)
    {
      NotificationChain msgs = null;
      if (dec != null)
        msgs = ((InternalEObject)dec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.DECLARATOR__DEC, null, msgs);
      if (newDec != null)
        msgs = ((InternalEObject)newDec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.DECLARATOR__DEC, null, msgs);
      msgs = basicSetDec(newDec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.DECLARATOR__DEC, newDec, newDec));
  }
