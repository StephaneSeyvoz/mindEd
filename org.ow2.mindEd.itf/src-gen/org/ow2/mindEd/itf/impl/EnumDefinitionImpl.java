 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.EnumDefinitionImpl#getEnumMemberList <em>Enum Member List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumDefinitionImpl extends EnumSpecificationImpl implements EnumDefinition
{
  ...
  {
    return ItfPackage.Literals.ENUM_DEFINITION;
  }
  ...
  public NotificationChain basicSetEnumMemberList(EnumMemberList newEnumMemberList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.ENUM_DEFINITION__ENUM_MEMBER_LIST, oldEnumMemberList, newEnumMemberList);
  ...
  public void setEnumMemberList(EnumMemberList newEnumMemberList)
  {
    if (newEnumMemberList != enumMemberList)
    {
      ...
      if (enumMemberList != null)
        msgs = ((InternalEObject)enumMemberList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.ENUM_DEFINITION__ENUM_MEMBER_LIST, null, msgs);
      if (newEnumMemberList != null)
        msgs = ((InternalEObject)newEnumMemberList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.ENUM_DEFINITION__ENUM_MEMBER_LIST, null, msgs);
      msgs = basicSetEnumMemberList(newEnumMemberList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.ENUM_DEFINITION__ENUM_MEMBER_LIST, newEnumMemberList, newEnumMemberList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.ENUM_DEFINITION__ENUM_MEMBER_LIST:
