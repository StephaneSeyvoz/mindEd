 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.InterfaceDefinitionImpl#getAnnotationsList <em>Annotations List</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.InterfaceDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.InterfaceDefinitionImpl#getFqn2 <em>Fqn2</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.InterfaceDefinitionImpl#getMethodDef <em>Method Def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterfaceDefinitionImpl extends MinimalEObjectImpl.Container implements InterfaceDefinition
{
  ...
  {
    return ItfPackage.Literals.INTERFACE_DEFINITION;
  }
  ...
  public NotificationChain basicSetAnnotationsList(AnnotationsList newAnnotationsList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.INTERFACE_DEFINITION__ANNOTATIONS_LIST, oldAnnotationsList, newAnnotationsList);
  ...
  public void setAnnotationsList(AnnotationsList newAnnotationsList)
  {
    if (newAnnotationsList != annotationsList)
    {
      ...
      if (annotationsList != null)
        msgs = ((InternalEObject)annotationsList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.INTERFACE_DEFINITION__ANNOTATIONS_LIST, null, msgs);
      if (newAnnotationsList != null)
        msgs = ((InternalEObject)newAnnotationsList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.INTERFACE_DEFINITION__ANNOTATIONS_LIST, null, msgs);
      msgs = basicSetAnnotationsList(newAnnotationsList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.INTERFACE_DEFINITION__ANNOTATIONS_LIST, newAnnotationsList, newAnnotationsList));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.INTERFACE_DEFINITION__NAME, oldName, name));
  }
  ...
  public InterfaceDefinition getFqn2()
  {
    if (fqn2 != null && fqn2.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ItfPackage.INTERFACE_DEFINITION__FQN2, oldFqn2, fqn2));
      }
    }
    return fqn2;
  }
  ...
  public void setFqn2(InterfaceDefinition newFqn2)
  {
    ...
    fqn2 = newFqn2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.INTERFACE_DEFINITION__FQN2, oldFqn2, fqn2));
  }
  ...
  public EList<MethodDefinition> getMethodDef()
  {
    if (methodDef == null)
    {
      methodDef = new EObjectContainmentEList<MethodDefinition>(MethodDefinition.class, this, ItfPackage.INTERFACE_DEFINITION__METHOD_DEF);
    }
    return methodDef;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.INTERFACE_DEFINITION__ANNOTATIONS_LIST:
        return basicSetAnnotationsList(null, msgs);
      case ItfPackage.INTERFACE_DEFINITION__METHOD_DEF:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ItfPackage.INTERFACE_DEFINITION__NAME:
        return getName();
      case ItfPackage.INTERFACE_DEFINITION__FQN2:
