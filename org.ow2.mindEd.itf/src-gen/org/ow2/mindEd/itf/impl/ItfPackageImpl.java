 ...
 * @generated
 */
public class ItfPackageImpl extends EPackageImpl implements ItfPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.itf.ItfPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ItfPackageImpl()
  {
    super(eNS_URI, ItfFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link ItfPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ItfPackage init()
  {
    if (isInited) return (ItfPackage)EPackage.Registry.INSTANCE.getEPackage(ItfPackage.eNS_URI);

    // Obtain or create and register package
    ItfPackageImpl theItfPackage = (ItfPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ItfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ItfPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theItfPackage.createPackageContents();

    // Initialize created meta-data
    theItfPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theItfPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ItfPackage.eNS_URI, theItfPackage);
    return theItfPackage;
  }
   ...
   * @generated
   */
  public ItfFactory getItfFactory()
  {
    return (ItfFactory)getEFactoryInstance();
  }
