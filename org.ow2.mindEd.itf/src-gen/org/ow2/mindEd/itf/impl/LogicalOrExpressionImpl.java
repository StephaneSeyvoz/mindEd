 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.LogicalOrExpressionImpl#getLeftExpr <em>Left Expr</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.LogicalOrExpressionImpl#getRightExpr <em>Right Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalOrExpressionImpl extends ConstantExpressionImpl implements LogicalOrExpression
{
  ...
  {
    return ItfPackage.Literals.LOGICAL_OR_EXPRESSION;
  }
  ...
  public NotificationChain basicSetLeftExpr(LogicalAndExpression newLeftExpr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.LOGICAL_OR_EXPRESSION__LEFT_EXPR, oldLeftExpr, newLeftExpr);
  ...
  public void setLeftExpr(LogicalAndExpression newLeftExpr)
  {
    if (newLeftExpr != leftExpr)
    {
      ...
      if (leftExpr != null)
        msgs = ((InternalEObject)leftExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.LOGICAL_OR_EXPRESSION__LEFT_EXPR, null, msgs);
      if (newLeftExpr != null)
        msgs = ((InternalEObject)newLeftExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.LOGICAL_OR_EXPRESSION__LEFT_EXPR, null, msgs);
      msgs = basicSetLeftExpr(newLeftExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.LOGICAL_OR_EXPRESSION__LEFT_EXPR, newLeftExpr, newLeftExpr));
  }
  ...
  public NotificationChain basicSetRightExpr(LogicalOrExpression newRightExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.LOGICAL_OR_EXPRESSION__RIGHT_EXPR, oldRightExpr, newRightExpr);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRightExpr(LogicalOrExpression newRightExpr)
  {
    if (newRightExpr != rightExpr)
    {
      NotificationChain msgs = null;
      if (rightExpr != null)
        msgs = ((InternalEObject)rightExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.LOGICAL_OR_EXPRESSION__RIGHT_EXPR, null, msgs);
      if (newRightExpr != null)
        msgs = ((InternalEObject)newRightExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.LOGICAL_OR_EXPRESSION__RIGHT_EXPR, null, msgs);
      msgs = basicSetRightExpr(newRightExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.LOGICAL_OR_EXPRESSION__RIGHT_EXPR, newRightExpr, newRightExpr));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.LOGICAL_OR_EXPRESSION__LEFT_EXPR:
        return basicSetLeftExpr(null, msgs);
      case ItfPackage.LOGICAL_OR_EXPRESSION__RIGHT_EXPR:
