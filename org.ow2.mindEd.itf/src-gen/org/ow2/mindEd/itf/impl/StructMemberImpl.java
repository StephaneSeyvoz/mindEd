...
import org.ow2.mindEd.itf.ConstantExpression;
 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.StructMemberImpl#getAnnotationsList <em>Annotations List</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.StructMemberImpl#getQualType <em>Qual Type</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.StructMemberImpl#getDec <em>Dec</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.StructMemberImpl#getConstExpr <em>Const Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StructMemberImpl extends MinimalEObjectImpl.Container implements StructMember
{
  ...
  {
    return ItfPackage.Literals.STRUCT_MEMBER;
  }
  ...
  public NotificationChain basicSetAnnotationsList(AnnotationsList newAnnotationsList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__ANNOTATIONS_LIST, oldAnnotationsList, newAnnotationsList);
  ...
  public void setAnnotationsList(AnnotationsList newAnnotationsList)
  {
    if (newAnnotationsList != annotationsList)
    {
      ...
      if (annotationsList != null)
        msgs = ((InternalEObject)annotationsList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__ANNOTATIONS_LIST, null, msgs);
      if (newAnnotationsList != null)
        msgs = ((InternalEObject)newAnnotationsList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__ANNOTATIONS_LIST, null, msgs);
      msgs = basicSetAnnotationsList(newAnnotationsList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__ANNOTATIONS_LIST, newAnnotationsList, newAnnotationsList));
  }
  ...
  public NotificationChain basicSetQualType(QualifiedTypeSpecification newQualType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__QUAL_TYPE, oldQualType, newQualType);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setQualType(QualifiedTypeSpecification newQualType)
  {
    if (newQualType != qualType)
    {
      NotificationChain msgs = null;
      if (qualType != null)
        msgs = ((InternalEObject)qualType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__QUAL_TYPE, null, msgs);
      if (newQualType != null)
        msgs = ((InternalEObject)newQualType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__QUAL_TYPE, null, msgs);
      msgs = basicSetQualType(newQualType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__QUAL_TYPE, newQualType, newQualType));
  }
  ...
  public NotificationChain basicSetDec(Declarators newDec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__DEC, oldDec, newDec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDec(Declarators newDec)
  {
    if (newDec != dec)
    {
      NotificationChain msgs = null;
      if (dec != null)
        msgs = ((InternalEObject)dec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__DEC, null, msgs);
      if (newDec != null)
        msgs = ((InternalEObject)newDec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__DEC, null, msgs);
      msgs = basicSetDec(newDec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__DEC, newDec, newDec));
  }
  ...
  public NotificationChain basicSetConstExpr(ConstantExpression newConstExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__CONST_EXPR, oldConstExpr, newConstExpr);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setConstExpr(ConstantExpression newConstExpr)
  {
    if (newConstExpr != constExpr)
    {
      NotificationChain msgs = null;
      if (constExpr != null)
        msgs = ((InternalEObject)constExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__CONST_EXPR, null, msgs);
      if (newConstExpr != null)
        msgs = ((InternalEObject)newConstExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.STRUCT_MEMBER__CONST_EXPR, null, msgs);
      msgs = basicSetConstExpr(newConstExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.STRUCT_MEMBER__CONST_EXPR, newConstExpr, newConstExpr));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.STRUCT_MEMBER__ANNOTATIONS_LIST:
        return basicSetAnnotationsList(null, msgs);
      case ItfPackage.STRUCT_MEMBER__QUAL_TYPE:
        return basicSetQualType(null, msgs);
      case ItfPackage.STRUCT_MEMBER__DEC:
        return basicSetDec(null, msgs);
      case ItfPackage.STRUCT_MEMBER__CONST_EXPR:
