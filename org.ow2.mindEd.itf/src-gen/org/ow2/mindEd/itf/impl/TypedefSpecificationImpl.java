 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.TypedefSpecificationImpl#getQualifedType <em>Qualifed Type</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.TypedefSpecificationImpl#getDec <em>Dec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypedefSpecificationImpl extends TypeDefinitionImpl implements TypedefSpecification
{
  ...
  {
    return ItfPackage.Literals.TYPEDEF_SPECIFICATION;
  }
  ...
  public NotificationChain basicSetQualifedType(QualifiedTypeSpecification newQualifedType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.TYPEDEF_SPECIFICATION__QUALIFED_TYPE, oldQualifedType, newQualifedType);
  ...
  public void setQualifedType(QualifiedTypeSpecification newQualifedType)
  {
    if (newQualifedType != qualifedType)
    {
      ...
      if (qualifedType != null)
        msgs = ((InternalEObject)qualifedType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.TYPEDEF_SPECIFICATION__QUALIFED_TYPE, null, msgs);
      if (newQualifedType != null)
        msgs = ((InternalEObject)newQualifedType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.TYPEDEF_SPECIFICATION__QUALIFED_TYPE, null, msgs);
      msgs = basicSetQualifedType(newQualifedType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.TYPEDEF_SPECIFICATION__QUALIFED_TYPE, newQualifedType, newQualifedType));
  }
  ...
  public NotificationChain basicSetDec(Declarators newDec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.TYPEDEF_SPECIFICATION__DEC, oldDec, newDec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDec(Declarators newDec)
  {
    if (newDec != dec)
    {
      NotificationChain msgs = null;
      if (dec != null)
        msgs = ((InternalEObject)dec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.TYPEDEF_SPECIFICATION__DEC, null, msgs);
      if (newDec != null)
        msgs = ((InternalEObject)newDec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.TYPEDEF_SPECIFICATION__DEC, null, msgs);
      msgs = basicSetDec(newDec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.TYPEDEF_SPECIFICATION__DEC, newDec, newDec));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.TYPEDEF_SPECIFICATION__QUALIFED_TYPE:
        return basicSetQualifedType(null, msgs);
      case ItfPackage.TYPEDEF_SPECIFICATION__DEC:
