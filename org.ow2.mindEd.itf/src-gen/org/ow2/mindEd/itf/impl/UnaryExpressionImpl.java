 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.itf.impl.UnaryExpressionImpl#getUnaryExpr <em>Unary Expr</em>}</li>
 *   <li>{@link org.ow2.mindEd.itf.impl.UnaryExpressionImpl#getPrimaryExpr <em>Primary Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnaryExpressionImpl extends MinimalEObjectImpl.Container implements UnaryExpression
{
  ...
  {
    return ItfPackage.Literals.UNARY_EXPRESSION;
  }
  ...
  public void setUnaryExpr(String newUnaryExpr)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.UNARY_EXPRESSION__UNARY_EXPR, oldUnaryExpr, unaryExpr));
  }
  ...
  public NotificationChain basicSetPrimaryExpr(PrimaryExpression newPrimaryExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ItfPackage.UNARY_EXPRESSION__PRIMARY_EXPR, oldPrimaryExpr, newPrimaryExpr);
  ...
  public void setPrimaryExpr(PrimaryExpression newPrimaryExpr)
  {
    if (newPrimaryExpr != primaryExpr)
    {
      ...
      if (primaryExpr != null)
        msgs = ((InternalEObject)primaryExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ItfPackage.UNARY_EXPRESSION__PRIMARY_EXPR, null, msgs);
      if (newPrimaryExpr != null)
        msgs = ((InternalEObject)newPrimaryExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ItfPackage.UNARY_EXPRESSION__PRIMARY_EXPR, null, msgs);
      msgs = basicSetPrimaryExpr(newPrimaryExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ItfPackage.UNARY_EXPRESSION__PRIMARY_EXPR, newPrimaryExpr, newPrimaryExpr));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ItfPackage.UNARY_EXPRESSION__PRIMARY_EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ItfPackage.UNARY_EXPRESSION__UNARY_EXPR:
        return getUnaryExpr();
      case ItfPackage.UNARY_EXPRESSION__PRIMARY_EXPR:
