 ...
 * @generated
 */
public class ItfSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ItfPackage.TYPE_DEFINITION:
      {
      ...
      case ItfPackage.STRUCT_OR_UNION_SPECIFICATION:
      {
      ...
      case ItfPackage.ENUM_SPECIFICATION:
      {
      ...
      case ItfPackage.CONSTANT_EXPRESSION:
      {
